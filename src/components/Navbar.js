...
const Navbar = (props) => {
  ...
  const onConnectWallet = async () => {
    ...
    if (!window.ethereum) {
      const newWindow = window.open(METAMASK_URL, '_blank', 'noopener,noreferrer');
      if (newWindow) newWindow.opener = null;
    } else {
      await props.load.loadWeb3();
      await props.load.loadBlockchaindata();
    }
  }
  ...
  return (
    <nav className={classes.container}>
      ...
      ><span><img src="../assets/img/logo.png" alt="logo"></img></span>
      ...
      <div className={classes.rightSideContainer}>
        ...
        <div className={classes.accountBtnContainer}>
          <div className={classes.accountBtn} onClick={onConnectWallet}>
            {props.account !== ""
